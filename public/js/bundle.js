...
},{"./es6.array.iterator":"../../node_modules/core-js/modules/es6.array.iterator.js","./_object-keys":"../../node_modules/core-js/modules/_object-keys.js","./_redefine":"../../node_modules/core-js/modules/_redefine.js","./_global":"../../node_modules/core-js/modules/_global.js","./_hide":"../../node_modules/core-js/modules/_hide.js","./_iterators":"../../node_modules/core-js/modules/_iterators.js","./_wks":"../../node_modules/core-js/modules/_wks.js"}],"controlador/alerta.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mostrarAlerta = exports.eliminarAlerta = void 0;
var eliminarAlerta = exports.eliminarAlerta = function eliminarAlerta() {
...
var mostrarAlerta = exports.mostrarAlerta = function mostrarAlerta(tipo, mensaje) {
  ...
  eliminarAlerta();
  var divAlerta = "<div class=\"alerta alerta--".concat(tipo, "\">").concat(mensaje, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', divAlerta);
  window.setTimeout(eliminarAlerta, 3000);
};
},{}],"controlador/api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePerfil = exports.updatePassword = exports.signup = exports.recuperarCuenta = exports.logout = exports.login = exports.enviarEmail = exports.emailForgotPassword = void 0;
var _alerta = require("./alerta.js");
...
var emailForgotPassword = exports.emailForgotPassword = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Correo Enviado❗ Verifica tu Email');
          }
          _context.next = 12;
          break;
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context.t0.response.data.message);
  ...
  return function emailForgotPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();
var recuperarCuenta = exports.recuperarCuenta = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, passwordConfirm, string) {
    var response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return axios({
            method: 'PATCH',
            url: "http://localhost:3000/api/v1/users/resetPassword/".concat(string),
            data: {
              password: password,
        ...
        case 3:
          ...
          console.log(response.data);
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Password Restablecido');
        ...
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context2.t0.response.data.message);
  ...
  return function recuperarCuenta(_x2, _x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          console.log(response.data);
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Has cerrado Sesion ❗');
            window.setTimeout(function () {
              window.location.replace('/home');
            }, 1000); // 1.0 segundos
          }
        ...
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context3.t0.response.data.message);
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          console.log(response.data);
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Login Exitoso ❗');
            window.setTimeout(function () {
        ...
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context4.t0.response.data.message);
        case 12:
        case "end":
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(nombre, email, password, passwordConfirm) {
    var response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          console.log(response.data);
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Signup Exitoso ❗');
        ...
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context5.t0.response.data.message);
        case 12:
        case "end":
...
var enviarEmail = exports.enviarEmail = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context6.t0.response.data.message);
        case 12:
        case "end":
  ...
  return function enviarEmail(_x11) {
    return _ref6.apply(this, arguments);
  };
}();
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(passwordActual, passwordNuevo, passwordNuevoConfirm) {
    var response;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          ...
          console.log(response.data);
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Password UPDATE Exitoso ❗');
            window.setTimeout(function () {
        ...
        case 8:
          ...
          (0, _alerta.mostrarAlerta)('error', _context7.t0.response.data.message);
  ...
  return function updatePassword(_x12, _x13, _x14) {
    return _ref7.apply(this, arguments);
  };
}();
var updatePerfil = exports.updatePerfil = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(formulario) {
    var response;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          console.log(response.data);
          if (response.data.status.startsWith('success')) {
            (0, _alerta.mostrarAlerta)('success', 'Perfil UPDATE  exitoso ❗');
            window.setTimeout(function () {
        ...
        case 9:
          ...
          (0, _alerta.mostrarAlerta)('error', _context8.t0.response.data.message);
  ...
  return function updatePerfil(_x15) {
...
*/
},{"./alerta.js":"controlador/alerta.js"}],"crearMapaBox.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.crearMapaBox = void 0;
// mapbox correo = vier_98@hotmail.com
// mapbox usuario = alexer98
// mapbox contraseña = XavierEsmeralda2021$

var crearMapaBox = exports.crearMapaBox = function crearMapaBox(mapaDiv) {
  var locaciones = JSON.parse(mapaDiv.dataset.mislocaciones);
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxleGVyOTgiLCJhIjoiY2xwdnR1MTNmMDgwZDJrcXFzcXB1eTV1eSJ9.lXmdDpNGy-vEfaXoH5kP-g';
  var opcionesMap = {
    container: 'mapa',
    // container ID // <div id="mapa" ></div>
    //style: 'mapbox://styles/mapbox/streets-v12', // style URL (predeterminador)
    style: 'mapbox://styles/alexer98/clpwpeumv010201qm75dj976a',
    // style (propio)
  ...
  locaciones.forEach(function (element) {
    // 1.0 crear marcador
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(element.coordenadas).setHTML("<p class=\"mapa-propio-popup\" >Dia ".concat(element.dia, ": ").concat(element.descripcion, "</p>")).addTo(map);
...
var api = _interopRequireWildcard(require("./controlador/api.js"));
var _crearMapaBox = require("./crearMapaBox.js");
...
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw new Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw new Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // para crear el archivo ---bundle.js y bundle.js.map--- basta con escribir ___npm run watch:js___
// asegurate de tener 02 terminales abiertas a la vez "npm run start:dev" y "npm run watch:js"
// esto es un paso opcional, si quitas esto funciona igual,
...
var botonLogout = document.querySelector('#btn-logout');
var mapa = document.querySelector('#mapa');
var menuUsuario = document.querySelector('.usuario-vista');
var passwordOlvidado = document.querySelector('#passwordOlvidado');
...
if (mapa) (0, _crearMapaBox.crearMapaBox)(mapa);
if (menuUsuario) formUpdate();
if (passwordOlvidado) formPasswordOlvidado();
if (resetPassword) formResetPassword();
function formPasswordOlvidado() {
  return _formPasswordOlvidado.apply(this, arguments);
}
function _formPasswordOlvidado() {
  _formPasswordOlvidado = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          passwordOlvidado.addEventListener('submit', /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 5;
                    return api.emailForgotPassword(email);
                  case 5:
                  case "end":
                    return _context.stop();
                }
...
function formResetPassword() {
  return _formResetPassword.apply(this, arguments);
}
function _formResetPassword() {
  _formResetPassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    string = window.location.pathname.replace('/recuperar-cuenta/', '');
                    _context3.next = 6;
                    return api.recuperarCuenta(password, passwordConfirm, string);
                  case 6:
                  case "end":
                    return _context3.stop();
                }
...
function btnLogout() {
  return _btnLogout.apply(this, arguments);
}
function _btnLogout() {
  _btnLogout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          botonLogout.addEventListener('click', /*#__PURE__*/function () {
...
function formLogin() {
  return _formLogin.apply(this, arguments);
}
function _formLogin() {
  _formLogin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    var login;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          login = document.querySelector('#formulario-login'); //recuerda que aqui es "submit" y no es "click"
          login.addEventListener('submit', /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
              var email, password, regex;
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    e.preventDefault();
...
function formSignup() {
  return _formSignup.apply(this, arguments);
} //---------------------------------------------------------------------------
function _formSignup() {
  _formSignup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
    var signup;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          signup = document.querySelector('#formulario-signup'); // recuerda que aqui es "submit" y no es "click"
          signup.addEventListener('submit', /*#__PURE__*/function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(e) {
              var nombre, email, password, passwordConfirm, regexNombre;
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    password = document.querySelector('#password').value;
                    passwordConfirm = document.querySelector('#password-confirm').value;
                    regexNombre = /^[A-Za-z\s]+$/; // const regexEmail = // el html ya valida @correos creo
                    //   /^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/;
                    if (!(!regexNombre.test(nombre) || password === '')) {
                      _context9.next = 8;
                      break;
                    }
                  ...
                  case 8:
                    ...
                    _context9.next = 11;
                    return api.signup(nombre, email, password, passwordConfirm);
                  case 11:
                  case "end":
...
function formUpdate() {
  return _formUpdate.apply(this, arguments);
}
function _formUpdate() {
  _formUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          ...
          document.querySelector('#cambiarNombreEmail').addEventListener('submit', /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(e) {
              var formulario;
              return _regeneratorRuntime().wrap(function _callee11$(_context11) {
                while (1) switch (_context11.prev = _context11.next) {
                  case 0:
                    ...
                    _context11.next = 7;
                    return api.updatePerfil(formulario);
                  case 7:
                  case "end":
          ...
          document.querySelector('#cambiarPassword').addEventListener('submit', /*#__PURE__*/function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(e) {
              var passActual, passNew, passConfirm;
              return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                while (1) switch (_context12.prev = _context12.next) {
                  case 0:
                    e.preventDefault();
                    passActual = document.querySelector('#password-actual').value;
                    passNew = document.querySelector('#password-nuevo').value;
                    passConfirm = document.querySelector('#password-confirm').value;
                    console.log({
                    ...
                    _context12.next = 7;
                    return api.updatePassword(passActual, passNew, passConfirm);
                  case 7:
                  case "end":
